...
class _4_AddContactEmailToSpConsentRequestsTable extends AbstractDbEntity implements MigrationInterface
{
    public function run(): void
    {
        $this->database->write(<<< EOT
        ALTER TABLE {$this->getPrefixedTableName()}
            ADD contact_email VARCHAR(255) NOT NULL AFTER challenge
